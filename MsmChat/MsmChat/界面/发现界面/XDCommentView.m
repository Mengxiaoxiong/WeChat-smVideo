...
@interface XDCommentView () <MLLinkLabelDelegate>
...
- (void)setupViews
{
    ...
    _bgImageView.backgroundColor = [UIColor colorWithRed:241/255.0 green:241/255.0 blue:241/255.0 alpha:1];
...
- (void)setCommentItemsArray:(NSArray *)commentItemsArray
{
    ...
    for (int i = 0; i < commentItemsArray.count; i++) {
        XDCircleOfFriendsCellCommentItemModel *model = commentItemsArray[i];
...
- (void)setLikeItemsArray:(NSArray *)likeItemsArray
{
    ...
    for (int i = 0; i < likeItemsArray.count; i++) {
        XDCircleOfFriendsCellLikeItemModel *model = likeItemsArray[i];
        if (i > 0) {
...
- (NSMutableAttributedString *)generateAttributedStringWithCommentItemModel:(XDCircleOfFriendsCellCommentItemModel *)model
{
...
- (NSMutableAttributedString *)generateAttributedStringWithLikeItemModel:(XDCircleOfFriendsCellLikeItemModel *)model
{
